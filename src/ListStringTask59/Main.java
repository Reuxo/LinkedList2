...
public class Main {
    public static void main(String[] args) {
        ...
        //list9_10.printList();
        //System.out.println();
        //System.out.println("Начинаются и заканчиваются на одинаковые буквы : " + HomeWorkIterator510.task5It(list5));
        //System.out.println(HomeWorkIterator510.task6It(list6));
        System.out.println("Совпадения с первым словом : " + HomeWorkIterator510.task7It(list7, true));
        System.out.println("Совпадения с последним словом : " + HomeWorkIterator510.task7It(list7, false));
